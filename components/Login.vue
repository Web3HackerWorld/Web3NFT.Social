...
const { doLogin, isLoading, error, isShowLoginModal } = $(web3AuthStore())
</script>
      ...
      <div class="mt-8 sm:mx-auto sm:w-full">
        <div class="bg-white py-8 px-4 sm:rounded-lg sm:px-10">
          <form class="space-y-6" action="#" method="POST">
            ...
            <div>
              <BsBtnBlack :is-loading="isLoading" class="w-full" @click="doLogin">
                {{ isLoading ? 'Waiting for action in your MetaMask' : 'Sign in With Metamask' }}
              </BsBtnBlack>
            </div>
          </form>
          ...
          <div class="mt-6 hidden">
            ...
            <div class="mt-6 grid gap-3 grid-cols-3">
              <div>
                <a href="#" class="bg-white rounded-md shadow-sm ring-inset w-full py-2 px-4 ring-1 ring-gray-300 text-gray-500 inline-flex justify-center hover:bg-gray-50 focus:outline-offset-0">
